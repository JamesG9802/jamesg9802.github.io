...
export default function UrRecallsContent() {
    ...
    <Text>
    Unfortunately refactoring the existing codebase proved to be a more daunting challenge. It was evident the previous teams either did not have a lot of experience with the technologies used. Documentation was non-existent, code styles changed haphazardly with unused files being scattered throughout the repository, and egregious security issues left vulnerable to exploitation. <Text className="font-bold inline">It was not optimal.</Text>
    </Text>
    <Text type="h2" className="mt-2">Solution</Text>
    <Text>
    Several techniques were utilized to tackle the problems. UI mockups were designed and iteratively refined to the business owner for feedback and improvement. Overall, this improved the <Text className="font-bold inline">user experience</Text> for the intended audience: ordinary consumers concerned about the safety of their food and drug products.
    </Text>
    <img
        src={UrRecalls}
    ...
    <ol className="list-disc list-inside my-4">
        <li>Migrating from JavaScript to the safer TypeScript.</li>
        <li>Using a standard styling theme and reusable components for the entire application.</li>
        <li>Fixing the API queries to improve performance.</li>
        <li>Documenting all existing and current work.</li>
    </ol>
    <Text>
    ...
    <Text>
    As my final project in my undergraduate studies, I tried to approach this project with the mindset of a professional developer. Compared to my earlier works, I can see how I placed a greater emphasis on <Text className="font-bold inline">readability and maintainability</Text> with more effort put into planning and designing solutions. It is my belief that, while my work may not have been perfect, it will have made the lives of future UrRecalls developers easier.
    </Text>
